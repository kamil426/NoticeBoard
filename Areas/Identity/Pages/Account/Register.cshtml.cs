...
namespace WebAnnouncementsApp.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [Compare("Password", ErrorMessage = "Wpisane hasło i hasło potweirdzające są różne.")]
        ...
        private IdentityUser CreateUser()
        {
            ...
            {
                throw new InvalidOperationException($"Nie można utworzyć instancji dla '{nameof(IdentityUser)}'. " +
                    $"Upewnij się, że '{nameof(IdentityUser)}' nie jest klasą abstrakcyjną i ma konstruktor bez paramatrów lub alternatywnie " +
                    $"nadpisz stronę rejestracji /Areas/Identity/Pages/Account/Register.cshtml");
            }
        }
